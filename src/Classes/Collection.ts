...
export default class Collection<K, V> extends Map<K, V> {
	 ...
	 */
	public map<U>(transformFn: (value: V, key: K, collection: Collection<K, V>) => U): Collection<K, U> {
	 ...
	 */
	public reduce<U>(reducer: (accumulator: U, value: V, key: K, collection: Collection<K, V>) => U, initialValue: U): U {
