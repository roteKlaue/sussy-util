...
import { AnyFunction, Constructor } from '../Types';
...
class IsSomething {
   ...
   * @returns A boolean value.
   */
  public isClass(arg: unknown): arg is Constructor<object> {
   ...
   * @returns A boolean value.
   */
  public isFunction(a: unknown): a is AnyFunction {
   ...
   * @returns The return value is a boolean.
   */
  public isInstanceOf(value: unknown, constructor: Constructor<object>): boolean | null {
